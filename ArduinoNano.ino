...
//NeoSWSerial bluetooth_serial(b_rx,b_tx);                          //creating instance of NeoSWSerial for bluetooth communication
...
//Bluetooth bluetooth(&bluetooth_serial,BAUD_RATE);                 //creating instance of Bluetooth
Bluetooth bluetooth(BAUD_RATE);                                     //creating instance of Bluetooth
